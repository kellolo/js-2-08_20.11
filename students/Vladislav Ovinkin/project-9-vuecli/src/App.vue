<template>
    <div id="app">
        <header>
            ...
            <div class="cart">
                <form action="#" class="search-form">
                    ...
                    <button class="btn-search" @click="filterCatalog" type="submit">
                        <i class="fas fa-search"></i>
                    </button>
                </form>
                <button class="btn-cart" type="button" @click="toggleCartShow">
                    Корзина
                    <span v-show="cartItemsCount > 0" class="btn-cart-items-counter">{{ cartItemsCount }}</span>
                </button>
        ...
        <main>
            ...
            <catalog ref="catalogComp"></catalog>
        </main>
    </div>
</template>
